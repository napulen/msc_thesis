...
Therefore, in practice, researchers have systematically split their efforts to target specific kinds of music, and even sometimes, specific composers. This is the case of this work as well, which as has been stated previously, deals around music composed by Joseph Haydn which represents the classical period of western art music.

 However, I believe that interesting observations and insight to the task of automatic harmonic analysis can be derived from the methods and models used in different kinds of music, particularly jazz. These observations are useful to better understand the key aspects of the problem of harmonic analysis in the music of Joseph Haydn composers alike.
