...
There is, however, the problem of choosing among the multiple ways in which this score can be represented. For this work, a symbolic representation in the humdrum format was chosen as the input format for this system. Similarly, the output consists of the same humdrum representation with an additional spine in the \emph{**harm} syntax. The justification behind this decision will be described during the dataset chapter of this report.
