...
However, thanks to the work that has been already done by David Temperley, Daniel Sleator and Craig Sapp, the idea of using an implemented model of this automatic harmonic analysis system over the dataset described in this work, which consists of musical scores encoded in humdrum files, is already feasible by putting together different programs and scripts. During this chapter I will introduce this software stack that allows for the automatic harmonic analysis of a humdrum music score.
