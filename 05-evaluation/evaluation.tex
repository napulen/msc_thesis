...
\section{Evaluation file}
	...
	The first pair of spines represents the roman numeral and harmonic root of the manual analysis, while the second represent the corresponding elements of the automatic analysis.
