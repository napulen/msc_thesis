  ...
  \subsection{Normalization of time units}
	...
	\subsection{Finding the shortest note}
		...
		In order to find the shortest note, I am simply using the \emph{census} program, which is part of the \emph{Humdrum Toolkit} \cite{humdrum}.
		 ...
		 \autoref{table:census} shows the output of the \emph{census} program for the humdrum file of the second movement of Op.20 No.3. Among the output of the \emph{KERN DATA} section, the duration of the shortest note of the humdrum score is displayed. This note duration can be used to make a new timebase for the score.
